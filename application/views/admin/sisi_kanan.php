 <!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">
                ...
                <?php if ($this->uri->segment(2)==='sms') {
                         $this->load->view('admin/sms',$sms_data);
                         $this->load->view('admin/modal/modal_kirim_sms');
                    } else if ($this->uri->segment(2)==='list_penjual') {
                        $this->load->view('admin/list_penjual',$all_penjual);
                        $this->load->view('admin/modal/modal_tambah_penjual');
                    }  else if ($this->uri->segment(2)==='list_transaksi' || $this->uri->segment(2)==='cariTransaksi') {
                        ...
                        $this->load->view('admin/peng_bank',$data_bank);
