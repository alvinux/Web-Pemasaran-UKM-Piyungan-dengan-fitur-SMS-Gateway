 						...
 						<div class="col-md-3 col-sm-4">
                            ...
                            <div style="margin-top: 15px;">
                            	<ul class="nav nav-pills nav-stacked">
                            		...
                            		<li class="active"><a href="#"><i class="fa fa-inbox"></i> Terbaru</a></li>
                            		<li><a href="#"><i class="fa fa-pencil-square-o"></i> Konfirmasi Pembayaran</a></li>
                            		<li><a href="#"><i class="fa fa-mail-forward"></i> Pending</a></li>
                            		<li><a href="#"><i class="fa fa-star"></i>  Lunas</a></li>
                            		<li><a href="#"><i class="fa fa-folder"></i> Batal</a></li>
                            	</ul>
                            </div>
                        </div><!-- /.col (LEFT) -->
