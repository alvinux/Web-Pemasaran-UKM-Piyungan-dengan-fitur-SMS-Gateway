	                         ...
	                         <div class="form-horizontal" >
	                           <!--  <div class="form-group">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-md-6">
	                                    <input class="form-control" placeholder="A/N Rekening Pengirim" name="nama_pengirim" type="text" >
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-md-6">
	                                    <input class="form-control" placeholder="Tanggal Transfer" name="tanggal_transfer" type="datetimepicker">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-md-6">
	                                    <input class="form-control" placeholder="Isikan Jumalah Transfer" name="jumlah_transfer" type="text">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-md-6">
	                                    <input class="form-control" placeholder="Isikan Nama Bank Pengirim, CTH('BCA'/'Mandiri'/'BRI' DLL)" name="bank_pengirim" type="text">
